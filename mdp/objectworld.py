...
class Objectworld(Gridworld):
    ...
    def __init__(self, grid_size, n_objects, n_colours, wind, discount):
        ...
        listo = [(0, 4), (0, 5), (0, 6), (0, 7), (1, 4), (1, 5), (1, 6), (1, 7),
                 (2, 5), (2, 6), (2, 7), (2, 0), (3, 0), (4, 0), (4, 7), (5, 0), (5, 7), (6, 0), (6, 7), (7, 0),
    ...
    def invert_world(self):
        ...
        #     inv_obj = (self.grid_size**2-1) - obj5
    ...
    def reward(self, state_int):
        ...
        if (x, y) in [(6, 6), (5, 6), (4, 6), (3, 6), (7, 6)]:
            near_c22 = True

        if (x, y) in [(5, 3), (5, 4), (5, 5), (6, 3), (6, 4), (6, 5), (4, 3), (4, 4), (4, 5)]:
            near_c23 = True
